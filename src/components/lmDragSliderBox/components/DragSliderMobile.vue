<template>
  <div class="drag-mobile" ref="dragDiv">
    <div class="drag-bgd" :style="{width: moveWidth+'px', height: '100%'}"></div>
    <div class="drag-text" :style="{color: fontColor}">{{confirmWords}}</div>
    <div ref="moveDiv"
